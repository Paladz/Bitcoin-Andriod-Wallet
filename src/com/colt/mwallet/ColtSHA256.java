...
public class ColtSHA256 extends Colt
{
	...
	//dude! i'm here!
	public static ColtSHA256 theOne=null;
	
	public ColtSHA256(File walletFile, File blockFile) throws IOException, UnreadableWalletException, BlockStoreException
	{
	...
	public static ColtSHA256 GettheOne()
	{
		return theOne;
	}
